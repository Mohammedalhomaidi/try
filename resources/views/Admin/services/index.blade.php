...
@section('content')
      ...
      <div class="card">
        <div class="card-header">
          ...
          @if(check_permeission_sub_menues_action(71)==true)
  ...
  @if($info->updated_by>0 and $info->updated_by!=null )
       ...
       <td>
       @if(check_permeission_sub_menues_action(72)==true)
       <a href="{{ route('admin.Services.edit',$info->id) }}" class="btn btn-sm  btn-primary">تعديل</a>   
           @endif
        @if(check_permeission_sub_menues_action(73)==true)
...
@section('script')
<script src="{{ asset('home/admin/js/services.js') }}"></script>
