...
<div class="card">
   <div class="card-header">
      ...
      @if(check_permeission_sub_menues_action(84)==true)
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           @if(check_permeission_sub_menues_action(85)==true)
                           ...
                           <a href="{{ route('admin.suppliers_orders.delete',$info->id) }}" class="btn btn-sm are_you_shue  btn-danger">حذف</a>   
                            @endif
                           @endif
                           @if(check_permeission_sub_menues_action(86)==true)
                           <a href="{{ route('admin.suppliers_orders.show',$info->id) }}" class="btn btn-sm   btn-info">التفاصيل</a>   
                           @endif
                           @if(check_permeission_sub_menues_action(90)==true)
