...
<div class="card">
   <div class="card-header">
      ...
      @if(check_permeission_sub_menues_action(40)==true)
         ...
         <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                  @if(check_permeission_sub_menues_action(41)==true)
                  <a href="{{ route('admin.delegates.edit',$info->id) }}" class="btn btn-sm  btn-primary">تعديل</a>   
                 @endif
                 @if(check_permeission_sub_menues_action(42)==true)
                 <button data-id="{{ $info->id }}" class="btn btn-sm show_more_details  btn-info">عرض  التفاصيل</button>   
                     @endif
                  </td>
               </tr>
               @endforeach
...
@endsection
@section('script')
<script src="{{ asset('home/admin/js/delegates.js') }}"></script>
@endsection