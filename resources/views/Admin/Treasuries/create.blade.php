...
<div class="row">
   <div class="col-12">
      <div class="card">
         ...
         <!-- /.card-header -->
         <div class="card-body">
            <form action="{{ route('admin.Treasuriesadded') }}" method="post" enctype="multipart/form-data">
               @csrf
               ...
               <div class="form-group">
                  ...
                  <select name="is_mester" id="is_mester" class="form-control">
                     <option value="">اختر النوع</option>
                     <option  @if(old('is_mester')==1) selected="selected"  @endif value="1"> نعم</option>
                     <option @if(old('is_mester')==0 and old('is_mester')!="") selected="selected"   @endif value="0"> لا</option>
                  </select>
                  @error('is_mester')
                  <span class="text-danger">{{ $message }}</span>
                  @enderror
               ...
               <div class="form-group text-center">
                  ...
                  <a href="{{ route('admin.TreasuriesPage') }}" class="btn btn-sm btn-danger">الغاء</a>    
               </div>
            </form>
         </div>
      </div>
