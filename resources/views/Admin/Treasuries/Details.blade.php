...
<a href="{{ route('admin.TreasuriesPage') }}"> الخزن </a>
@endsection
         ...
         <div class="card-body">
            ...
            <table id="example2" class="table table-bordered table-hover">
               ...
               <tr>
                  ...
                  <td > @if($data['is_mester']==1) نعم  @else لا @endif</td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <td > 
                     ...
                     لايوجد تحديث
                     @endif
                     <a href="{{ route('admin.TreasuriesEdit',$data['id']) }}" class="btn btn-sm btn-success">تعديل</a>
                     <a href="{{ route('admin.TreasuriesPage') }}" class="btn btn-sm btn-info">عودة</a>
                  </td>
               </tr>
            </table>
            <!--  treasuries_delivery   -->
            <div class="card-header">
               <h3 class="card-title card_title_center">الخزن الفرعية التي سوف تسلم عهدتها الي الخزنة ( {{ $data['name'] }} )  
                  <a href="{{ route('admin.Treasuries_Delivery.add',$data['id']) }}" class="btn btn-sm btn-primary">اضافة جديد</a>
               </h3>
            </div>
               ...
               <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="{{ route('admin.delete_treasuries_delivery',$info->id) }}" class="btn btn-sm btn-danger are_you_shue">حذف</a>
                        </td>
                     </tr>
                     @php
                     $i++; 
