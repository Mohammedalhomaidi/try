...
@section('content')
      ...
      <div class="card">
        <div class="card-header">
          ...
          <input type="hidden" id="ajax_search_url" value="{{ route('admin.admin_shift.review_now') }}"> 
          <input type="hidden" id="review_now_url" value="{{ route('admin.admin_shift.review_now') }}"> 
      @if(check_permeission_sub_menues_action(65)==true)
...
<div class="modal fade  "   id="review_nowmodal">
      <div class="modal-dialog modal-xl"  >
         <div class="modal-content bg-info">
            <div class="modal-header">
               <h4 class="modal-title text-center">     مراجعة واستلام نفدية شفت خزينة  </h4>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
               <span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body" id ="review_nowmodalbody" style="background-color: white !important; color:black;">
...
@section('script')
<script src="{{ asset('home/admin/js/admin_shift.js') }}"></script>
