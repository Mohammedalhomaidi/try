...
@section('content')
      ...
      <div class="card">
        <div class="card-header">
          ...
          @if(check_permeission_sub_menues_action(100)==true)
       ...
       @if($info->is_approved==0)
            @if(check_permeission_sub_menues_action(101)==true)
...
@section('script')
<script src="{{ asset('home/admin/js/suppliers_with_order.js') }}"></script>
