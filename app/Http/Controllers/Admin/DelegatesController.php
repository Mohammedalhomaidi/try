...
{ check_permeission_Redirection(43);
...
$delegates_parent_account_number = get_field_value(new Admin_panel_settings(), "delegate_parent_account_number", array('com_code' => $com_code));
