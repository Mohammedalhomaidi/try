...
class SuppliersController extends Controller
{
 ...
 { check_permeission_Redirection(49);
...
$suppliers_parent_account_number = get_field_value(new Admin_panel_settings(), "suppliers_parent_account_number", array('com_code' => $com_code));
