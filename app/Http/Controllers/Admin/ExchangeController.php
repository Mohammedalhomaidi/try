...
public function storeAndprint(Exchange_transactionRequest $request){
...
//fi rst get isal number with treasuries 
...
if($account_type==2){
   ...
   $systemData=get_cols_where_row(new Admin_panel_settings(),array("system_name","phone","address","photo"),array("com_code"=>$com_code));
       ...
       return view('admin.exchange_transaction.printsaleswina4',['data'=>$data,'systemData'=>$systemData ]);
   }
   } catch (\Exception $ex) {
