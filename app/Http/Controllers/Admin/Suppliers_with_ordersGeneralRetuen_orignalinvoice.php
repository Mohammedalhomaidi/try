...
class Suppliers_with_ordersGeneralRetuen_orignalinvoice extends Controller
{
public function index()
{check_permeission_Redirection(102);
...
$stores = get_cols_where(new Stores(), array('id', 'name'), array('com_code' => $com_code, 'id' => $parent_pill_data['store_id']), 'id', 'DESC');
